...
export default React.memo(function OrderCompleteItemTile({ data, index }:
    ...
    return (
        <div className='w-full min-h-[11rem]  h-[11rem] gap-5 flex p-2'>
            ...
            {/** image container */}
            <div className='h-[10rem] aspect-square bg-[var(--main-bg-secondary)] rounded-[8px] overflow-hidden'>
...
const QuantityAction = ({ quantity, index }: QuantityProp) => {
    ...
    return <div className='button-primary-gradient w-[100px] h-[2rem] rounded-[3px] flex justify-evenly items-center text-[1rem] text-white'>
        <button
