...
const page = () => {
  ...
  return (
    <div className='w-screen h-screen bg-[var(--main-bg-primary)] dark:bg-[var(--main-bg-primary-dark)] flex relative overflow-hidden'>
      <GlobalWrapper>
        <div className='w-full h-full flex flex-col relative'>
          <PosAppbar />
          {/** body */}
          <div className='flex-1 flex bg-[var(--main-bg-primary-dark)] min-h-0'>
            <PosProductList />
            <PosCartList />
          </div>
