...
import { PromotionalDiscountKeys } from '@/app/lib/constants/NewProductKeys';
import monthsName from '@/app/lib/data/MonthsList';
import { PromotionalDiscountProp } from '@/app/lib/models/newProductModel';
import { updatePromotionalDiscount, toggleDatePicker } from '@/app/lib/redux/newProductSlice';
            ...
            <div className='flex w-full mt-2 gap-1'>
                ...
                <div className='flex-1'>
                    <textarea name={PromotionalDiscountKeys.description}
                        maxLength={200}
                        value={description}
                        className='w-full border border-[var(--primary)] rounded-[7px] h-[3rem] min-h-[3rem] max-h-[8rem] p-2'
                ...
                {/** discount */}
                <div className='flex-1'>
                    <input type="text" maxLength={3} value={discountRate} name={PromotionalDiscountKeys.discountRate} className='w-full border border-[var(--primary)] rounded-[7px] max-h-[3rem] min-h-[3rem] p-2'
                ...
                <div className='flex-1 flex max-h-[3rem] min-h-[3rem]'>
                    ...
                    <button className='linear-bg-40 flex-1 rounded-[7px]'
