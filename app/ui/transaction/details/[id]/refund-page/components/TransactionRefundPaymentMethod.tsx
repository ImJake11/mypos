...
const TransactionRefundPaymentMethod = () => {
    ...
    return (
        <div className='w-full flex flex-col gap-1'>
            ...
            {paymenthMethod === PaymentMethod.E_WALLET && <div className='w-full flex flex-col gap-2'>
...
function Options({
    ...
    return <div className='w-full flex gap-2 ml-6'>
        <div className='w-[1rem] h-[1rem] rounded-full relative border border-gray-300'
            onClick={onClick}
        >
