...
function TransactionTF({
    ...
    return <div className="flex-1 flex flex-col gap-2">
        <span>{name}</span>
        <input type="text" placeholder={placeHolder} value={value ?? ""} className={`w-full min-h-[2rem] p-2 border border-gray-500 rounded-[8px] outline-0 focus:border-[var(--color-brand-primary)]`}
            style={{
