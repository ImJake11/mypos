...
function TransactionDateFilter() {
    ...
    return <div className='flex flex-col w-full'>
        ...
        <div className="flex w-full gap-3 items-center">
            ...
            <div className="flex-1 h-[2.5rem] rounded-[8px] border border-gray-400 grid place-content-center">
                {start}
            </div>
            <button onClick={() => {
        ...
        <div className="h-[2rem] w-[10rem] grid place-content-center">
            <div className="h-[2rem] w-[1px] border border-gray-500 border-dashed" />
        </div>
        ...
        <div className="flex w-full gap-3 items-center">
            ...
            <div className="flex-1 h-[2.5rem] rounded-[8px] border border-gray-500 grid place-content-center">
                {end}
            </div>
            <button onClick={() => {
...
function ButtonTile({ name, onClick }: {
    ...
    return <button className="w-[10rem] h-[2.5rem] rounded-[8px] bg-[var(--color-brand-primary)] grid place-content-center text-white"
        onClick={onClick}
    >
        {name}
    </button>
